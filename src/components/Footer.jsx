function Footer() {
  return (
    <div className="flex gap-5  w-full h-screen bg-zinc-900 font-['Bebas Neue']">
      <div className="w-1/2 h-full flex flex-col justify-between  p-20 ">
        <div className="headling">
          <h1 className="text-8xl uppercase leading-none font-semibold">Eye</h1>
          <h1 className="text-8xl uppercase leading-none font-semibold">
            -Opening
          </h1>
        </div>
        <div>
      ...
      <div className="w-1/2 h-screen flex flex-col">
        ...
        <div className="dets mt-10">
          {["Instagram", "Behance", "Facebook", "Linkedin"].map(
            (item, index) => (
              <ul key={index}>
                <li><a className="text-xl font-light" href="#">{item}</a></li>
              </ul>
            )
          )}
        </div>
